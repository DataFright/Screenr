...
describe('Suite 3: File Upload Tests', () => {
  ...
  const getFileInput = () => cy.get(fileInputSelector).first()
  ...
  it('Test 3.1: Should accept single PDF file', () => {
    ...
    getFileInput().selectFile(`${testResumesDir}/01_senior_dev_excellent.pdf`, uploadOptions)
  ...
  it('Test 3.2: Should show file size in KB', () => {
    ...
    getFileInput().selectFile(`${testResumesDir}/01_senior_dev_excellent.pdf`, uploadOptions)
    cy.contains('01_senior_dev_excellent.pdf')
      .parent()
      .should('contain.text', 'KB')
  ...
  it('Test 3.4: Should accumulate files on multiple uploads', () => {
    ...
    getFileInput().selectFile(`${testResumesDir}/02_mid_level_good.pdf`, uploadOptions)
    cy.get('[data-sonner-toast]').should('contain.text', 'Added 1 file(s)')
  ...
  it('Test 3.8: Should have correct file input attributes', () => {
    ...
    getFileInput().should('have.attr', 'type', 'file')
    getFileInput().should('have.attr', 'multiple')
